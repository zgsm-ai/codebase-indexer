...
//		return nil, err
//	}
//	s.logger.Debug("get: starting transaction", "project", projectUuid, "key", keyStr)
//
...
//		return err
//	}
//	s.logger.Debug("delete: starting transaction", "project", projectUuid, "key", keyStr)
//
//	return db.Update(func(tx *bbolt.Tx) error {
//		bucket := tx.Bucket([]byte("data"))
//		if bucket == nil {
...
//		}
//
//		if err := bucket.Delete([]byte(keyStr)); err != nil {
//			return fmt.Errorf("failed to delete key %s: %w", keyStr, err)
//		}
//
//		s.logger.Debug("delete: completed", "project", projectUuid, "key", keyStr)
//		return nil
//	})
//}
//
...
//		db := value.(*bbolt.DB)
//
//		s.logger.Info("close: closing database", "projectUuid", projectUuid)
//		if err := db.Close(); err != nil {
//			s.logger.Error("close: failed to close database", "projectUuid", projectUuid, "error", err)
//			errs = append(errs, fmt.Errorf("failed to close project %s database: %w", projectUuid, err))
//		} else {
//			s.logger.Info("close: successfully closed database", "projectUuid", projectUuid)
//		}
//		return true
//	})
//
...
//
//	if it.tx == nil {
//		it.storage.logger.Debug("next: getting database", "project", it.projectUuid)
...
//		}
//
//		it.storage.logger.Debug("next: starting transaction", "project", it.projectUuid)
...
//		if bucket == nil {
//			it.err = fmt.Errorf("data bucket not found in project %s", it.projectUuid)
//			return false
//		}
//
